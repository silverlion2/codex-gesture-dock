...
- 摄像头工作区可切换姿态、QR/条码、智能文档扫描、文件 OCR、名片 OCR、人脸隐私、人物背景、物体识别与图片对比，并支持设备选择、镜像/原图和填满/完整预览
...
- 图片对比可导入两张最大 35 MB 的 PNG、JPEG、WebP 或 BMP，在本机按左上角对齐并用 Pixelmatch 计算感知像素差异；支持键盘可调的前后滑动对照、三档容差、相似度/差异范围指标和差异 PNG 导出。尺寸不同时补白并明确警告，不把像素相似度描述为功能或视觉质量结论
