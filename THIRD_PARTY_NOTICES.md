...
verified asset hashes for version 0.6.2; CI rejects stale output.
...
| @tesseract.js-data/chi_tra | 1.0.0 | Apache-2.0 |
| @tesseract.js-data/eng | 1.0.0 | Apache-2.0 |
| @types/pako | 2.0.4 | MIT |
| @types/raf | 3.4.3 | MIT |
| @types/trusted-types | 2.0.7 | MIT |
| @zxing/browser | 0.2.0 | MIT |
| @zxing/library | 0.22.0 | Apache-2.0 |
