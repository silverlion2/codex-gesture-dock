...
describe('TaskPicker', () => {
  ...
  it('keeps the newest filter result when an older request resolves late', async () => {
    ...
    window.widgetControls = {
      ...
      runWindowsAction: vi.fn(),
      setPointerControlEnabled: vi.fn(),
      sendPointerCommand: vi.fn(),
      getVoiceControlStatus: vi.fn(),
      setVoiceControlEnabled: vi.fn(),
      getUpdateStatus: vi.fn(),
      checkForUpdates: vi.fn(),
      installUpdate: vi.fn(),
      getCodexIntegrationStatus: vi.fn(),
      inspectCodexUi: vi.fn(),
      setWindowsControlEnabled: vi.fn(),
